...
Archived from commit `9d69654` on 2026-08-28. This records earlier plans and
analysis instructions; it is not the current paper reproduction procedure.
Use [the documentation index](../README.md) for the reported study.
