...
the named notebook sections to probe a platform, collect and compare its smoke
pair, preview or execute the next plan row, and report collection quality.
Locked-test rows remain unavailable until explicitly unlocked after the method
freeze.
